# CIBMTR Prep Regimen Medication - CIBMTR Reporting Implementation Guide v0.1.11
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-prep-regimen-medication | *Version*:0.1.11 |
| Draft as of 2026-06-11 | *Computable Name*:CIBMTR_PrepRegimenMedication |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/nmdp.fhir.cibmtr-reporting|current/StructureDefinition/cibmtr-prep-regimen-medication)
