# CBC W Ordered Manual Differential panel - Blood (57782-5) - CIBMTR Reporting Implementation Guide v0.1.11
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/cbc-w-ordered-manual-differential-blood-vs | *Version*:0.1.11 |
| Draft as of 2026-06-22 | *Computable Name*:CBCWOrderedManualDifferentialBloodVS |
...
```json
{
  ...
  "compose" : {
    "include" : [
      ...
      {
        "valueSet" : [
          "http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/manual-differential-blood-vs"
        ]
      }
    ]
  }
