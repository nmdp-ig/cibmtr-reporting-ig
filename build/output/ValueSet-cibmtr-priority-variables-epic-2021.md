# CIBMTR Priority Variables Value Set for Epic App (FY21) - CIBMTR Reporting Implementation Guide v0.1.10

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CIBMTR Priority Variables Value Set for Epic App (FY21)**

## ValueSet: CIBMTR Priority Variables Value Set for Epic App (FY21) 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/cibmtr-priority-variables-epic-2021 | *Version*:0.1.10 |
| Draft as of 2026-04-23 | *Computable Name*:PriorityVariablesEpic2021 |
...
```json
{
  ...
  "url" : "http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/cibmtr-priority-variables-epic-2021",
  "version" : "0.1.10",
  "name" : "PriorityVariablesEpic2021",
    ...
    "include" : [
      {
        ...
        "concept" : [
          ...
          {
            "code" : "35194-0",
            "display" : "Bilirubin.total [Mass or Moles/volume] in Serum or Plasma"
          },
          {
            "code" : "1975-2",
          ...
          {
            "code" : "35214-6",
            "display" : "Iron [Mass or Moles/volume] in Serum or Plasma"
          },
          {
            "code" : "2498-4",
          ...
          {
            "code" : "35215-3",
            "display" : "Iron binding capacity [Mass or Moles/volume] in Serum or Plasma"
          },
          {
            "code" : "2500-7",
          ...
          {
            "code" : "35209-6",
            "display" : "Ferritin [Mass or Moles/volume] in Serum or Plasma"
          },
          {
            "code" : "24373-3",
          ...
          {
            "code" : "705-4",
            "display" : "Basophils [#/volume] in Blood by Manual count"
          },
          {
            "code" : "6863-5",
            "display" : "Prolymphocytes [#/volume] in Blood by Manual count"
          }
        ]
      }
    ]
