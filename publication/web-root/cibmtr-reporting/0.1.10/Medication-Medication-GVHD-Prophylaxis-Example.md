# Medication-GVHD-Prophylaxis-Example - CIBMTR Reporting Implementation Guide v0.1.10
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-gvhd-prophylaxis-medication"
    ],
    "security" : [
      {
