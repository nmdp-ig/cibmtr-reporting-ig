# Medication-Post-HCT-Disease-Therapy-Example - CIBMTR Reporting Implementation Guide v0.1.10
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-post-hct-disease-therapy-planned-medication"
    ],
    "security" : [
      {
