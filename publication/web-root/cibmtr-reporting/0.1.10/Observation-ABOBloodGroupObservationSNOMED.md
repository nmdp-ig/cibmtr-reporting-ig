# ABOBloodGroupObservationSNOMED - CIBMTR Reporting Implementation Guide v0.1.10

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ABOBloodGroupObservationSNOMED**

## Example Observation: ABOBloodGroupObservationSNOMED
...
```json
{
  ...
  "id" : "ABOBloodGroupObservationSNOMED",
  "meta" : {
    "profile" : [
