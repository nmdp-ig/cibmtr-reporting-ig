# CIBMTR Mobilizing Agents Medication - CIBMTR Reporting Implementation Guide v0.1.10
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-mobilizing-agent-medication | *Version*:0.1.10 |
| Draft as of 2026-05-27 | *Computable Name*:CIBMTR_MobilizingAgentMedication |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/nmdp.fhir.cibmtr-reporting|current/StructureDefinition/StructureDefinition-cibmtr-mobilizing-agent-medication.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://vsac.nlm.nih.gov/valueset/2.16.840.1.113762.1.4.1295.2/expansion"
      }
    }]
  }
}
