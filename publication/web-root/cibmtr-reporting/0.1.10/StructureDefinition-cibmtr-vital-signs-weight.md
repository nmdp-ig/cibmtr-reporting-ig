# CIBMTR Vital Signs-Weight Profile (us-core) - CIBMTR Reporting Implementation Guide v0.1.10
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-vital-signs-weight | *Version*:0.1.10 |
| Draft as of 2026-04-23 | *Computable Name*:CIBMTRVitalSignsWeight |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/nmdp.fhir.cibmtr-reporting|current/StructureDefinition/cibmtr-vital-signs-weight)
