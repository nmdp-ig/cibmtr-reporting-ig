# Vital Signs - CIBMTR Reporting Implementation Guide v0.1.11
...
* `valueQuantity` 
* per [US-Core Laboratory Vital Signs](https://hl7.org/fhir/us/core/StructureDefinition-us-core-vital-signs.html), **SHALL** use UCUM for coded quantity units. For example,
