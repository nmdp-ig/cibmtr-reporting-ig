# CIBMTR Medication (us-core) - CIBMTR Reporting Implementation Guide v0.1.12
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/StructureDefinition/cibmtr-medication | *Version*:0.1.12 |
| Draft as of 2026-08-28 | *Computable Name*:CIBMTR_Medication |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/nmdp.fhir.cibmtr-reporting|current/StructureDefinition/StructureDefinition-cibmtr-medication.json)
