# Manual Differential panel - Blood (24318-8) - CIBMTR Reporting Implementation Guide v0.1.12

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Manual Differential panel - Blood (24318-8)**

## ValueSet: Manual Differential panel - Blood (24318-8) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/manual-differential-blood-vs | *Version*:0.1.12 |
| Draft as of 2026-08-28 | *Computable Name*:ManualDifferentialBloodVS |
...
```json
{
  ...
  "url" : "http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/manual-differential-blood-vs",
  "version" : "0.1.12",
  "name" : "ManualDifferentialBloodVS",
  ...
  "compose" : {
    "include" : [{
      "valueSet" : ["http://fhir.nmdp.org/ig/cibmtr-reporting/ValueSet/smear-morphology-blood-vs"]
    },
    {
      ...
      {
        "code" : "58445-8",
        "display" : "Manual differential comment [Interpretation] in Blood Narrative"
      }]
    }]
  }
}
